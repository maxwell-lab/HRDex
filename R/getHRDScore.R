...
getHRD.Score <- function( seq.dat, CN.dat, min.seg.size = 3e06, scaleTotal = FALSE, type = "sum" )
...
{
  HRD.Score <- getLOH(  seq.dat, min.seg.size ) + getLST(  seq.dat ) + getNTAI.norm( seq.dat, CN.dat, min.seg.size )
